...
/* Subscribe to the events that the service wants to receive */
...
/* Receive events from the services and send them to the services that are subscribed to that event. */
